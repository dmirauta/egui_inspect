...
```toml
[dependencies]
egui_inspect = { git = "https://github.com/dmirauta/egui_inspect", branch="0_35" } # adjust branch according to version
# egui_inspect_wrap = { git = "https://github.com/dmirauta/egui_inspect", branch="0_35" } # add separately if required
```
